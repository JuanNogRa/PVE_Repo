...
class MainWindow(QtWidgets.QMainWindow, Ui_MainWindow):
    ...
    Time_hold_value=5                   #Variable para guardar el tiempo del retenedor que el usuario digita para la prueba de consumo
    velocidad_max=30                    #Variable para guardar la velocidad maxima a la cual se va a realizar la prueba de consumo
    Time_hold_rango_value=5             #Variable para guardar el tiempo del retenedor que el usuario digita para la prueba de rango
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.pos_indicador1.setFont(QFont('Arial', 40))
    ...
    def update_plot_1(self):
        ...
        if(self.Velocidad_actual-self.Velocidad_perfil_actual<-5):
            ...
            self.pos_indicador1.setText('Acelere')
            ...
            self.pos_indicador1.setText('Desacelere')
            self.Measure_Gauge_3.setStyleSheet(
                """QProgressBar {
                    border: 2px solid rgba(33, 37, 43, 180);
                    border-radius: 5px;
            ...
            self.pos_indicador1.setText('Mantener')
            self.Measure_Gauge_3.setStyleSheet(
                """QProgressBar {
                    border: 2px solid rgba(33, 37, 43, 180);
                    border-radius: 5px;
    ...
    def update_plot_coastdown(self):
        ...
        if self.State_coastdown==0:
            ...
            if(self.Velocidad_actual-self.Velocidad_perfil_actual+10>-2 and self.Velocidad_actual-self.Velocidad_perfil_actual+10<2):
                if self.Time_coastdown.isFinished():
    ...
    def CicloManejoPath(self):
        ...
        """self.msg.setText('Ciclo de manejo seleccionado para prueba de consumo.')
        self.msg.show()"""
    ...
    def CicloManejoPath_rango(self):
        ...
        """self.msg.setText('Ciclo de manejo seleccionado para prueba de rango.')
        self.msg.show()"""
    ...
    def CicloVelocidad(self): 
        if self.Velo_max.text() !='':        
            ...
            self.msg.setText('La velocidad máxima configurada es de '+self.Velo_max.text()+' m/s.')
            self.msg.show()             
    ...
    def EmpezarCiclo(self):
        ...
        self.Time_coastdown = Do_every(5)
    ...
    def Calcular_eficiencia_function(self):
        ...
        Energy = integrate.trapz(self.Potencia_values['voltaje']*self.Potencia_values['corriente']*1e-3, x=self.Potencia_values['tiempo']/3600)                                                                                         #Calculo de la energía toma los valores de corriente y voltaje se multiplica y se calcula el area bajo la curva vs el tiempo (h) con la regla trapezoidal.
        ...
        Energia_consumo = (Energy)/(integrate.trapz(self.Consumo_values['Velocidad longitudinal (km/h)'].dropna(), x=self.Consumo_values['Velocidad longitudinal (km/h)'].dropna().index*(0.01/3600)))                                  #Calculo de la posición por medio de la integral con la regla del trapezoide a partir de la velocidad longitudinal. (Prueba de consumo)
        ...
        Energia_rango = (integrate.trapz(self.Rango_values['Velocidad longitudinal (km/h)'].dropna(), x=self.Rango_values['Velocidad longitudinal (km/h)'].dropna().index*(0.01/3600)))                                                 #Calculo de la posición por medio de la integral con la regla del trapezoide a partir de la velocidad longitudinal. (Prueba de rango)
        self.Valor_consumo.setText(str(Energia_consumo))
        self.Valor_rango.setText(str(Energia_rango))
        self.path_potencia = ''
