...
"}")
        ...
        self.file_path_perfil = QtWidgets.QLineEdit(self.groupBox)
        self.file_path_perfil.setObjectName("file_path_perfil")
        self.gridLayout.addWidget(self.file_path_perfil, 3, 1, 1, 1)
        self.Load_perfil = QtWidgets.QPushButton(self.groupBox)
        self.Load_perfil.setText("")
        self.Load_perfil.setIcon(icon1)
        self.Load_perfil.setObjectName("Load_perfil")
        self.gridLayout.addWidget(self.Load_perfil, 3, 2, 1, 1)
        self.Accept_perfil = QtWidgets.QPushButton(self.groupBox)
        self.Accept_perfil.setText("")
        self.Accept_perfil.setIcon(icon)
        self.Accept_perfil.setObjectName("Accept_perfil")
        self.gridLayout.addWidget(self.Accept_perfil, 3, 3, 1, 1)
...
"perfil de velocidad"))
        ...
        self.label_17.setText(_translate("MainWindow", "Archivo .csv de perfil de velocidad (opcional):"))
